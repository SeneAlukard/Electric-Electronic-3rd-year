...
SecondaryVoltages = [0 3.1 4.9 6.8 8.6 10.6;
                     2.4 6.7 17 19.4 19.9 24.3; 
                     3.5 10.1 16.6 23.3 29.8 36.3
                     ].';
...
T = table(Array3(:,1), Array3(:,2), Array3(:,3), Array3(:,4), Array3(:,5), Array3(:,6), Array3(:,7),'VariableNames', {'PrimeVolt', 'A1-B1', 'a1', 'A2-B2', 'a2', 'A3-B3', 'a3'});
